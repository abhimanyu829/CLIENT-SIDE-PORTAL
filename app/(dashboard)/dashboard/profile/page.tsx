...
export default async function ProfilePage() {
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-8">
      <section className="rounded-2xl border border-border bg-card p-4 shadow-sm backdrop-blur-xl sm:p-6">
        <div className="mb-4">
          <h1 className="text-2xl font-black text-foreground font-sans">Account center</h1>
        ...
        <ClerkLoaded>
          <UserProfile routing="hash" appearance={clerkAuralisAppearance} />
        </ClerkLoaded>
        <ClerkLoading>
          <div className="flex min-h-[420px] items-center justify-center rounded-[1.5rem] border border-border bg-muted/20">
            <div className="h-10 w-10 animate-spin rounded-full border-4 border-border border-t-primary" />
          </div>
        </ClerkLoading>
        <ClerkFailed>
          <div className="rounded-[1.5rem] border border-red-500/20 bg-red-500/10 p-6 text-center text-sm text-red-600">
